...
const DEMO_ANSWERS: Record<string, string> = {
  offer_name: "Codify — Context Architect. We extract, structure, and operationalize your institutional knowledge so AI works for your business, not against it. 30+ years of expertise, codified into a system that compounds.",
  offer_outcome: "You go from decades of expertise trapped in your head to a version-controlled business brain that compounds. AI knows your business before you ask it anything. Outputs sound like you from the first draft. Your institutional knowledge is preserved, scaled, and generating revenue without you getting busier.",
  offer_price: "Focus Engagement is $1,497 — full Context Architect experience. Soul Mining interview, reference stack built for you, Opportunity Scout configured, first batch of automated outputs. Then Brain Sync at $497/month — monthly context audit, market alignment, unlimited generations, and direct access.",
  offer_audience: "Mature senior executives with 30+ years of institutional knowledge. Business owners doing $500K to $10M+ who know their expertise is their competitive advantage. Leaders who want AI to amplify their knowledge, not replace their thinking.",
  offer_differentiator: "I built this system for my own business first — 48 reference files, 73 research docs, 322+ commits, 9 hrs/week. I'm not selling prompts or AI consulting reports that sit in drawers. I'm the Context Architect — I extract and operationalize your knowledge into a system that compounds forever. You own your files, your repo, your context. I own the engine.",
};
