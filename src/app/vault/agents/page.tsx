  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-6">
      ...
      <div className="flex items-center gap-0.5 bg-[#1a1a1a] rounded-full p-0.5 mb-6">
        ...
        <button
          onClick={() => router.push("/vault/agents/all")}
      ...
      {/* ═══ 4 suggestion cards — horizontal row ═══ */}
      <div className="grid grid-cols-4 gap-3 mt-6 w-full max-w-2xl">
        {EXTRACT_SKILLS.map((skill) => (
          <button
            ...
            className="flex flex-col gap-1.5 p-3 bg-surface border border-border rounded-xl hover:border-blue/30 transition-colors text-left group"
          >
